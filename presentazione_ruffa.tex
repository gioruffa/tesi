    		...
    		\column{0.5\textwidth}
			   \begin{flushleft}
			   	\only<1,\fftPos,\fftscatterPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_0.pdf}	
				}
				\only<2>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_PWSCF.pdf}	
				}
				\only<\inputPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_init_run.pdf}	
				}
				\only<\electronsPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_electrons.pdf}	
				}				
				\only<\cegtergPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_cegterg.pdf}	
				}
				\only<\hpsiPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_h_psi.pdf}	
				}
				\only<\cdiaghgPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_cdiaghg.pdf}	
				}
				\only<\sumbandPos>{
					\includegraphics[height=0.53\textheight, width=1.1\textwidth]{beam_SCF_sum_bands.pdf}	
				}
				...
				\only<\sumbandPos>{
					\begin{block}{Calcolo densit\`a elettronica} 
						\begin{itemize}
							...
							\item $\displaystyle \dens = \sum_{i} \psi_{i}^{*KS}(\erre) ~ \psi_{i}^{KS}(\erre)$
						\end{itemize}
					\end{block}
				}
