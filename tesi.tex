...
For each of the main subroutines the average \textit{cpu time}, \textit{wall time} and the number of calls are printed.
...
In this work we used mainly the internal PWscf's metrics, \texttt{scorep} was used for in-depth analysis of the call graph and to compute the percentage time spent during MPI communication.
...
\subsubsection{Configuration summary}\label{sec:ConfSummary}
metti essenzialmente i make.sys dell'espresso sui due sistemi.
