...
In fact, by looking at the plot at fixed number of iterations, on the right of figure \ref{fig:threadsOverall}, we see that (especially at eight cores) the advantage is still substantial.
...
\begin{figure}[hhh!]
\centerline{ \includegraphics[width=1.2\linewidth]{arch_global_2.jpg}	}
...
\newpage
\begin{figure}[hhh!]
	\centerline{\includegraphics[width=1.\linewidth]{app_iterations_distro1.pdf}}
...
\newpage
\begin{figure}[hhh!]
	\centerline{\includegraphics[width=1.\linewidth]{app_iterations_distro2.pdf}}
	\caption{ Iteration CPU time statistics
	}
	\label{fig:fixedvsvariablespeedup}
\end{figure}
