...
In section \ref{sec:comparch} we will outline the main features of the computational architecture we had tested.
...
Sections \ref{sec:results} is dedicated to expose all the results we have obtained, characterizing how \QE adapts to each architecture, outlining how the critical components of the code performs and proposing simple rules to reach the best performance on any system.
