...
In order to better understand DFT's foundations, it is convenient to introduce the atomic model developed by Thomas and Fermi in the late 20s. The model was later refined by Dirac including exchanges effects.
...
\end{equation}
Then the equation for Lagrange multipliers has the form:
\begin{equation}
...
\mynotes{metti le citazioni ad articoli originali di fermi e thomas. Quello di Dirac, boh???}
