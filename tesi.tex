...
\item \textbf{Batch system}: Not required
...
In this framework all the work of intercommunication is demanded to the NUMAlink interconnect, which basically migrates pages of memory to minimize local reference misses.
...
Tutto quello fatto per azzerare il bias
...
\begin{itemize}
	\item process pinning, dlook, nodeinfo. QE si comporta bene, gestisce bene la memoria.
	\item MPT
