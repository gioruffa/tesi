...
In figure \ref{fig:ndiag64} we report the data for run at 64 cores.
...
Starting from Galileo we it is evident that increasing $n_{diag}$ is very convenient when only one cluster node is used, i.e. at sixteen cores.
...
\begin{figure}[hhh!]
\centerline{ \includegraphics[width=1.2\linewidth]{concl_co3.pdf}	}
	\caption{}
	\label{fig:conclCo3}
\end{figure}
...
\newpage
\begin{figure}[hhh!]
\centerline{ \includegraphics[width=0.7\linewidth]{concl_ausurf.pdf}	}
	\caption{}
	\label{fig:conclCo3}
\end{figure}
