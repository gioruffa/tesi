...
\end{equation}
where $D$ is the number dimensions, $\{\mathbf{a}_{i}\}$ is as a set of $D$ linear independent vectors and $n_{i}$ is always an integer number.
The definition appears clear looking at figure \ref{fig:BravaisLattice}

\begin{figure}[h]
\begin{center}
	\includegraphics[width=0.4\linewidth]{Bravais_2D.png}
	\caption{Bi-dimensional Bravais lattice}
...
The \textit{Wigner-Seitz} cell around a lattice point is defined as the locus of points in space that are closer to that lattice point than to any of the other lattice points (see figure \ref{fig:WSCell}).
...
We will see that the duality between the direct lattice and the reciprocal lattice is one of the greatest strength of theories based on plane waves basis sets.

\subsection{Plane Waves}
\mynotes{da fogli di Davide + dispense Davide su plane waves + Martins}
