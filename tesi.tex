...
Note that the tuning of the size of the communicators is effective only on massively parallelized infrastructure (i.e. at least a couple hundreds of cores, well beyond the scope and the resources of this work) where it is important to keep communicating ranks as closed as possible\cite{QE},\cite{QE2}.
...
The easiest way to affect the algorithm used for diagonalization and optimize the performance is to introduce the use of threads. 
