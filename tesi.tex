...
\footnote{Although their suffix one should not think of them as a "real" spacial representation. What we are about to do is to model the space of possible energies as a vector space. This will bring may simplifications.}
...
If R is large enough we can approximate the total number of levels with energy lower then $\varepsilon(R)$ as the volume contained in an octet of a sphere:
\begin{equation}
