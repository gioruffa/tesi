...
\begin{framed}
Then the UV2000 machine can be used to perform different independent calculation simultaneously, provided that each node is used separately.
\end{framed}


SCRIVI CHE ABBIAMO SEMPRE USATO LA MACCHINA SCARICA
