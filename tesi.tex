...
The variational principle comes in help stating that the exact ground state solution to the Schr\"oedinger equation $\hat{H} \ket{\Psi} = E \ket{\Psi}$ is the one that minimizes the functional 
