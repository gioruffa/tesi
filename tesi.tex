...
A comparison between HF and DFT was performed to underline how this new theory can overcome previous computational limits.
...
Given the knowledge accumulated we finally had all the tools to properly tune the computational architecture for QE calculations.
...
To conclude this work we propose two plots that summarizes the improvements obtained by applying the tuning strategies discussed above.
...
%migliorare stabilita' numerica di ogni iterazione

%investigare a fondo perche' il numero diverso id core a disposizione abbia degli impatti cosi' grandi sulla stabilita' SCF
