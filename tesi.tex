...
Se vuoi comparazione su speedup, che vuol dire niente \ref{app:IterationDynamic}.
...
Parlare un po' di scaling delle varie funzioni.
...
Introduciamo quindi i thread e facciamo tutte le prove possibili con tutti i threads.

I threads alterano il tipo di algoritmo utilizzato.
...
Questo risultato e' molto interessante per chi fa high throughput.
...
Tutto questo succede perche' $\Delta \rho$ viene usato per fissare la convergenza della Davidson!
...
\centerline{ \includegraphics[width=\linewidth]{threads_subroutines.pdf}	}
	\caption{Il guadagno sta in cdiaghg, cegterg va su meglio ma contiene anche hpsi, conviene perdere su hpsi e guadagnare sulla diag. hpsi e sumband scalano come le fftw perche' quello fanno. In piu' hanno la parte di somma che si fa con le alltoall a stecca.}
	\label{fig:threadsSubroutines}

\end{figure}


Per fare un confronto con figura \ref{fig:relevantSubroutines} basta guardare figura \ref{fig:threadsRelevantSubroutines};
\begin{figure}[hhh!]
\centerline{ \includegraphics[width=0.7\linewidth]{threads_relevant_subroutines.pdf}	}
	\caption{Il bump e' sparito}
