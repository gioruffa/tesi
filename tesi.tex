...
We can impute this to the increasing relevance of matrix diagonalization over matrix evaluation\footnote{We have seen that \texttt{h\_psi} speedup difference is less impac	ting that \texttt{cdiaghg}'s one.} and the subsequent necessity of high performance communication as said above and in \cite{QE2}.
...
%How this theory translates into an algorithm and how this algorithm is implemented.
%Also the numerical complexity of each step was investigated.
